...
> [!TIP]
> You can view the live implementation of these engines in the [templates directory](https://github.com/VeriWorkly/veriworkly/tree/master/apps/studio/templates) on GitHub.
...
The react-pdf renderer produces documents locally with low latency, direct coordinate control, and no server-side browser workers.
