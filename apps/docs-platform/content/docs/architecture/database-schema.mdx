...
[apps/server/prisma/schema.prisma](https://github.com/Gautam25Raj/veriworkly-resume/blob/main/apps/server/prisma/schema.prisma)
...
For the complete list of models including Roadmap and GitHub Sync entities, refer to the [full schema file](https://github.com/Gautam25Raj/veriworkly-resume/blob/main/apps/server/prisma/schema.prisma).
